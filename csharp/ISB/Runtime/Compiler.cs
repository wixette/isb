...
namespace ISB.Runtime
{
    ...
    {
        // Compile() can be invoked incrementally, i.e., the syntax tree of a new source code segment can be passed
        // in to be compiled.
        //
        // env contains the context info of the existing code:
        //
        // (1) env.CompileTimeLabels and env.CompileTimeSubNames will be checked to avoid symbol dups.
        //
        // (2) Auto labels generated by the compiler (for implemnting the control flows) need a global counter to
        //       avoid dups. env.NextAutoLabelNo keeps track of the largest number that has been used before.
        //
        // (3) It's the caller's duty to merge the output assembly, newLabels and newSubNames to the existing ones.
        ...
        //
        // This method is not recommended to be used in an incremental compilation.
